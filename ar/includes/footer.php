    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 last-paragraph-no-margin order-5 order-sm-4 order-lg-1 text-center text-sm-start">
                <a href="index.php" class="footer-logo mb-15px d-block d-lg-inline-block"><img src="./images/gipam/gipam-white.png" data-at2x="./images/gipam/gipam-white.png" alt="" width="150px" style="max-height: 90px; border-radius: 5px;"></a>
                
            </div>
            <!-- end footer column -->
            <!-- start footer column -->
            <div class="col-4 col-lg-2 col-sm-4 md-mb-50px sm-mb-30px order-1 order-lg-2">
                <span class="alt-font d-block text-white mb-5px">GIPAM</span>
                <ul>
            ...
            <div class="col-4 col-lg-2 col-sm-4 md-mb-50px sm-mb-30px order-3 order-lg-4">
                <span class="alt-font d-block text-white mb-5px lh-1">Social connect</span>
                <ul>
                    <li class="fs-14px"><a href="https://www.facebook.com/profile.php?id=100082850852679" target="_blank"><i class="fa-brands fa-facebook"></i> Facebook</a></li>
                    <li class="fs-14px"><a href="https://www.linkedin.com/groups/13735705/" target="_blank"><i class="fa-brands fa-linkedin"></i> LinkedIn</a></li>
                </ul>
                <span class="alt-font d-block text-white mb-5px mt-9 lh-1">Retrouvez nous</span>
                <ul>
                    <li class="fs-14px"><a href="https://maps.app.goo.gl/4AA1N7KDgNYwStai9" target="_blank"><i class="fa-regular fa-map"></i> Google Maps</a></li>
            ...
            <div class="col-4 col-lg-3 col-sm-6 xs-mb-30px last-paragraph-no-margin order-4 order-sm-5 order-lg-5">
                <span class="alt-font d-block text-white mb-5px lh-1">Prendre Contact</span>
                <p class="w-90 lg-w-100 md-w-70 sm-w-100 mb-10px fs-13">357, BD Mohamed V, 7 Étage Espace 8, Casablanca, Maroc</p>
...
<div class="sticky-wrap z-index-1 d-none d-xl-inline-block" data-animation-delay="100" data-shadow-animation="true">
    <span class="fs-13 fw-500"></i>FABRICANTS - IMPORTATEURS - DISTRIBUTEURS - SERVICES</span>
</div>
<!-- end sticky column -->
                ...
                <div class="row g-0 position-relative">
                    ...
                    <div class="col-lg-7">
                        <div class="p-14 xl-p-11 bg-white">
                            <span class="mb-5px d-block">Badge accès au Salon.</span>
                            <h5 class="d-inline-block alt-font fw-600 text-dark-gray mb-8 ls-minus-1px">Remplissez le formulaire suivant. Vous recevrez votre confirmation de badge par email.</h5>
                            <form id="badgeForm">
                                <div class="position-relative form-group mb-15px">
                                    ...
                                    <div id="nameError" style="color: red; display: none;">Veuillez saisir un nom valide.</div>
                                </div>
                                <div class="position-relative form-group mb-15px">
                                    ...
                                    <div id="companyError" style="color: red; display: none;">Veuillez saisir un nom d'entreprise valide.</div>
                                </div>
                                <div class="position-relative form-group mb-15px">
                                    <span class="form-icon"><i class="bi bi-envelope"></i></span>
                                    <input type="email" id="email" name="email" class="form-control required" placeholder="Votre email*" required />
                                    <div id="emailError" style="color: red; display: none;">Veuillez saisir une adresse email valide.</div>
                                </div>
                                <div class="position-relative form-group mb-15px">
                                    <span class="form-icon"><i class="bi bi-telephone-outbound"></i></span>
                                    <input type="tel" id="phone" name="phone" class="form-control required" placeholder="Votre numéro de téléphone*" required />
                                    <div id="phoneError" style="color: red; display: none;">Veuillez saisir un numéro de téléphone valide.</div>
                                </div>
                                <div class="position-relative form-group mb-15px">
                                    <select class="form-select required" id="activity" name="activity" aria-label="Default select example" required>
                                        ...
                                        <option value="Fabricants">Fabricants de pièces de rechange</option>
                                        <option value="Importateurs/Distributeurs">Importateurs / Distributeurs des IAM Indépendants After-market</option>
                                        <option value="Maintenance">MRA – Maintenance Rapide</option>
                                        <option value="Petroliers">Pétroliers</option>
                                    ...
                                    <div id="activityError" style="color: red; display: none;">Veuillez choisir une activité.</div>
                                </div>
                                <div class="position-relative form-group form-textarea">
                                    <button class="btn btn-medium btn-box-shadow btn-round-edge w-100 btn-base-color mt-15px" id="submitBadgeForm" type="submit">Envoyer ma Demande de Badge</button>
    ...
    <script type="application/ld+json">
        {
            ...
            "logo": "https://www.mat-expo.ma/images/mat/logo/logo_mat.png",
