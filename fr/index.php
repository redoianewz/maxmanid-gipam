    ...
    <div class="swiper lg-no-parallax  full-screen md-h-600px sm-h-500px ipad-top-space-margin swiper-light-pagination" data-slider-options='{ "slidesPerView": 1, "loop":  true, "parallax": true, "speed": 4000, "pagination": { "el": ".swiper-pagination-bullets", "clickable": true }, "navigation": { "nextEl": ".slider-one-slide-next-1", "prevEl": ".slider-one-slide-prev-1" }, "autoplay": { "delay": 6000, "disableOnInteraction": false },  "keyboard": { "enabled": true, "onlyInViewport": true }, "effect": "slide" }'>
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide overflow-hidden">
                <div class="cover-background position-absolute top-0 start-0 w-100 h-100" data-swiper-parallax="500" style="background-image:url('./images/gipam/bg-1.png');">
                    ...
                    <div class="container h-100" data-swiper-parallax="-500">
                        <div class="row align-items-center h-100">
                            <div class="col-xl-10 col-lg-10 col-md-10 position-relative z-index-1" data-anime='{ "el": "childs", "translateY": [0, 0], "perspective": [1200,1200], "scale": [1.05, 1], "rotateX": [30, 0], "opacity": [0,1], "duration": 800, "delay": 200, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                <h1 class="text-white fw-600 ls-minus-1px mb-25px sm-fs-50">Le Groupement Interprofessionnel de L’automobile au Maroc</h1>
                                <div>
                                    <p class="fw-500 fs-20 w-85 sm-w-95 text-white opacity-9">Le Groupement des fabricants, importateurs et distributeurs des pièces de rechange pour tout type de véhicule au Maroc.</p>
                                </div>
                                <a href="index.html" class="btn btn-extra-large btn-switch-text btn-danger btn-rounded me-10px ls-0px mt-15px">
                                    <span>
                                        <span class="btn-double-text" data-text="Rejoindre le GIPAM">Rejoindre le GIPAM</span>
                                ...
                                <a href="demo-it-business-contact.html" class="btn btn-extra-large btn-switch-text btn-transparent-white-light btn-rounded border-1 ls-0px mt-15px">
                                    <span>
                                        <span class="btn-double-text" data-text="Nous Contacter">Nous Contacter</span>
            ...
            <!-- start slider item -->
            <div class="swiper-slide overflow-hidden">
                <div class="cover-background position-absolute top-0 start-0 w-100 h-100" data-swiper-parallax="500" style="background-image:url('./images/gipam/bg-2.jpeg');">
                    <div class="opacity-light bg-gradient-sherpa-blue-black"></div>
                    <div class="container h-100" data-swiper-parallax="-500">
                        <div class="row align-items-center h-100">
                            <div class="col-xl-10 col-lg-10 col-md-10 position-relative text-white text-center text-md-start" data-anime='{ "el": "childs", "translateX": [100, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                                <div>
                                    <span class="fs-40 mb-25px sm-mb-15px d-inline-block fw-600 sm-fs-20">Du 14 au 17
                                        Novembre 2024</span>
                                </div>
                                <h1 class="alt-font w-90 xl-w-100 text-shadow-double-large ls-minus-1px fw-600 sm-fs-40">M.A.T :
                                    <span class="fw-300">Moroccan Automotive Technologies</span>
                                </h1>
                                <div>
                                    <span class="sm-fs-15 fs-30 opacity-8 sm-mb-15px d-inline-block fw-500 lift-text">Le rendez-vous des intervenants de l'après-vente indépendants sous le thème :
                                    </span>
                                </div>
                                <div>
                                    <span class="fs-25 sm-fs-15 mb-5px sm-mb-15px d-inline-block fw-600 lift-text">Mutation et révolution de l’écosystème de la réparation et maintenance automobile au Maroc</span>
                                </div>
        ...
        <div class="row mb-5 align-items-center">
            <div class="col-lg-5 position-relative md-mb-20">
                <div class="w-70 xs-w-80" data-animation-delay="50" data-shadow-animation="true">
                    <img src="images/gipam/1.png" alt="" class="border-radius-8px w-100">
                </div>
                <div class="w-60 overflow-hidden position-absolute right-minus-15px xs-right-15px xs-w-60 bottom-minus-50px" data-shadow-animation="true" data-animation-delay="250" data-bottom-top="transform: translateY(50px)" data-top-bottom="transform: translateY(-50px)">
                    <img src="images/gipam/2.png" alt="" class="border-radius-8px w-100 box-shadow-quadruple-large" />
                </div>
            </div>
                ...
                <div class="row align-items-center position-relative xs-ps-15px z-index-9">
                    <div class="col-md-auto menu-item ps-40px pe-40px lg-ps-30px lg-pe-30px position-relative">
                        ...
                        <a href="" class="menu-item-text fs-150 lg-fs-120 md-fs-100 sm-fs-70 lh-100 text-white text-white-hover fw-600 ls-minus-4px sm-ls-minus-1px">
                            <span class="title">Fabricants</span>
                        </a>
                        <div class="hover-reveal d-none d-xl-block">
                            <div class="hover-reveal__inner">
                                <div class="hover-reveal__img" style="background-image: url(images/gipam/cat-1.png);">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-auto menu-item ps-40px pe-40px lg-ps-30px lg-pe-30px position-relative">
                        ...
                        <a href="" class="menu-item-text fs-150 lg-fs-120 md-fs-100 sm-fs-70 lh-100 text-white text-white-hover fw-600 ls-minus-4px sm-ls-minus-1px">
                            <span>Importateurs</span>
                        </a>
                        <div class="hover-reveal d-none d-xl-block">
                            <div class="hover-reveal__inner">
                                <div class="hover-reveal__img" style="background-image: url(images/gipam/cat-2.png);">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-auto menu-item ps-40px pe-40px lg-ps-30px lg-pe-30px position-relative">
                        ...
                        <div class="hover-reveal d-none d-xl-block">
                            <div class="hover-reveal__inner">
                                <div class="hover-reveal__img" style="background-image: url(images/gipam/cat-3.png);">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-auto menu-item ps-40px pe-40px lg-ps-30px lg-pe-30px position-relative">
                        ...
                        <div class="hover-reveal d-none d-xl-block">
                            <div class="hover-reveal__inner">
                                <div class="hover-reveal__img" style="background-image: url(images/gipam/cat-4.png);">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center mb-7">
            <div class="col-xl-5 col-lg-6 mb-30px" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <h5 class="text-dark-gray fw-700 ls-minus-1px mb-50px">Nos Engagements pour le Marché de la Pièce de Rechange Automobile au Maroc</h5>
                <div class="row row-cols-1">
                    ...
                    <div class="col-12 process-step-style-05 position-relative hover-box">
                        <div class="process-step-item d-flex">
                            ...
                            <div class="process-content ps-35px sm-ps-25px last-paragraph-no-margin mb-40px">
                                <span class="d-block fw-600 text-dark-gray fs-17 mb-5px">Structuration</span>
                                <p>Aujourd'hui la part de l'informel ne représente plus que 10% du marché contre 30% il y a 10 ans. Et ce grâce aux efforts du GIPAM et de ses partenaires institutionnels.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 process-step-style-05 position-relative hover-box">
                        <div class="process-step-item d-flex">
                            ...
                            <div class="process-content ps-35px sm-ps-25px last-paragraph-no-margin mb-40px">
                                <span class="d-block fw-600 text-dark-gray fs-17 mb-5px">Sécurité</span>
                                <p>Nous collaborons  depuis notre  création à l'élaboration de normes, standard qualité et labels pour assurer  aux consommateurs un produit de qualité et fiable.</p>
                            </div>
                        </div>
                    </div>
                    <!-- end process step item -->
                    ...
                    <div class="col-12 process-step-style-05 position-relative hover-box">
                        <div class="process-step-item d-flex">
                            ...
                            <div class="process-content ps-35px sm-ps-25px last-paragraph-no-margin mb-30px">
                                <span class="d-block fw-600 text-dark-gray fs-17 mb-5px">Développement</span>
                                <p>Nous défendons les intérêts des indépendants de l'après-vente automobile en favorisant un environnement propice à la croissance. (bonnes pratiques, formation etc).</p>
                            </div>
                        </div>
                    </div>
                    <!-- end process step item -->
            ...
            <div class="col-lg-6 text-center md-mb-20px offset-xl-1">
                <figure class="position-relative mb-0 overflow-hidden" data-shadow-animation="true" data-bottom-top="transform: translateY(70px)" data-top-bottom="transform: translateY(-70px)">
                    <img src="images/gipam/gipam-board.png" class="w-100 border-radius-6px" alt="">
                    <figcaption class="position-absolute border-radius-4px text-center right-30px bottom-30px pt-35px pb-35px ps-5px pe-5px bg-white-transparent glass-effect">
                        ...
                        <span class="d-block mx-auto fs-14 fw-700 lh-20 w-200px text-center text-dark-gray text-uppercase">ans d'existance</span>
                    </figcaption>
                </figure>
            </div>
        </div>
                    ...
                    <div class="atropos-rotate">
                        <div class="atropos-inner text-center overflow-visible position-relative">
                            <div data-atropos-offset="-8">
                                <span class="fs-200 lg-fs-130 sm-fs-90 text-dark-gray fw-500 ls-minus-5px">GIPAM MOROCCO</span>
                            </div>
                            <span class="fs-70 md-fs-50 xs-fs-40 text-white ls-minus-5px text-shadow-double-large fw-600 position-absolute absolute-middle-center text-white-space-nowrap z-index-1">Innover - Connecter - Structurer & Unir</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-3">
            <div class="col-lg-7 text-center">
                <h3 class="alt-font text-dark-gray ls-minus-1px fw-700">Comité de Direction</h3>
            </div>
        </div>
        <div class="row align-items-center mb-5 xs-mb-35px">
            <div class="col-lg-4 md-mb-30px" data-anime='{ "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                <div class="text-center team-style-07 bg-white border-radius-6px box-shadow-extra-large box-shadow-quadruple-large-hover">
                    <img src="images/gipam/elhousnimohamed.png" class="border-radius-6px w-100" alt="El Housni Mohamed">
                    <div class="team-content p-30px">
                        <div class="primary-font fs-19 fw-600 text-dark-gray">EL HOUSNI Mohamed</div>
                        <span class="fs-16 lh-22 d-block mb-15px">Président du GIPAM</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-8" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                <div class="row mb-30px">
                    <div class="col-md-6 sm-mb-30px">
                        <div class="row g-0 box-shadow-extra-large box-shadow-quadruple-large-hover border-radius-6px overflow-hidden" style="height: 150px;">
                            <div class="col-5 cover-background" style="background-image: url(images/gipam/guennoundriss.png)">
                            </div>
                            <div class="col-7 bg-white ps-35px pt-30px pb-30px xs-ps-20px">
                                <span class="primary-font fs-18 fw-600 text-dark-gray d-block">GUENNOUN Driss</span>
                                <span class="fs-16 lh-22 d-block">⁠Vice Président</span>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="row g-0 box-shadow-extra-large box-shadow-quadruple-large-hover border-radius-6px overflow-hidden" style="height: 150px;">
                            <div class="col-5 cover-background" style="background-image: url(images/gipam/elhousniachraf.png)">
                            </div>
                            <div class="col-7 bg-white ps-35px pt-30px pb-30px xs-ps-20px">
                                <span class="primary-font fs-18 fw-600 text-dark-gray d-block">EL HOUSNI Achraf</span>
                                <span class="fs-16 lh-22 d-block">Secrétaire Général</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row mb-30px">
                    <div class="col-md-6 sm-mb-30px">
                        <div class="row g-0 box-shadow-extra-large box-shadow-quadruple-large-hover border-radius-6px overflow-hidden" style="height: 150px;">
                            <div class="col-5 cover-background" style="background-image: url(images/gipam/hafyanchakib.png)">
                            </div>
                            <div class="col-7 bg-white ps-35px pt-30px pb-30px xs-ps-20px">
                                <span class="primary-font fs-18 fw-600 text-dark-gray d-block">HAFYANE Chakib</span>
                                <span class="fs-16 lh-22 d-block">Secrétaire Général Adjoint</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="row g-0 box-shadow-extra-large box-shadow-quadruple-large-hover border-radius-6px overflow-hidden" style="height: 150px;">
                            <div class="col-5 cover-background" style="background-image: url(images/gipam/dichaziz.png)">
                            </div>
                            <div class="col-7 bg-white ps-35px pt-30px pb-30px xs-ps-20px">
                                <span class="primary-font fs-18 fw-600 text-dark-gray d-block">DICH Aziz</span>
                                <span class="fs-16 lh-22 d-block">Trésorier</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 sm-mb-30px">
                        <div class="row g-0 box-shadow-extra-large box-shadow-quadruple-large-hover border-radius-6px overflow-hidden" style="height: 150px;">
                            <div class="col-5 cover-background" style="background-image: url(images/gipam/jamalmikou.png)">
                            </div>
                            <div class="col-7 bg-white ps-35px pt-30px pb-30px xs-ps-20px">
                                <span class="primary-font fs-18 fw-600 text-dark-gray d-block">MIKOU Jamal</span>
                                <span class="fs-16 lh-22 d-block">Trésorier Adjoint</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row align-items-center h-850px md-h-500px text-center justify-content-center">
            <div class="col-12 position-relative">
                <h2 class="text-white alt-font fw-600 ls-minus-1px text-shadow-extra-large">Retour sur l'édition précédente du <br> Moroccan Automotive Technologies (M.A.T) 2022</h2>
            </div>
        </div>
    </div>
